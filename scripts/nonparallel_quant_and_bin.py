	...
	with open(md_file) as metadata:
		for md_line in metadata:
			...
			if(assay=="ChIP-seq"):
				...
				os.system("./scripts/run_epireg.sh "+outfile_name+" "+id+" "+chr+" "+str(start)+" "+str(end)+" "+assembly+" "+outfolder)
			...
			if(assay=="RNA-seq"):
				...
				os.system("./scripts/run_epireg.sh "+outfile_name+" "+gene+" "+R1+" "+str(R2)+" "+outfolder + " " +enst)
